        ...
        <div className='login-bg-container'>
            ...
            <div className='login-cont-head' >
                ...
                <form onSubmit={onLogin} className='loginform' >
                    ...
                    <input className='input' id='username' onChange={oninpName} value={userNameInput}  type='text' placeholder="User Name"/>
                    <label htmlFor='password' className='label' >password</label>
                    <input className='input' id='password' onChange={onInpPass} value={passwordInput}  type='password' placeholder="rewrfw@14w"/>
